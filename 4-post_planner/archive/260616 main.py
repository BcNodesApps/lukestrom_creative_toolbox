...
PLATFORMS = [
    {
        "name": "Meta (IG/FB)",
        "header": "META (IG/FB)",
        "url_label": "Meta Business Suite",
        "url": URL_FACEBOOK,
    },
    {
        "name": "YouTube",
        "header": "YOUTUBE",
        "url_label": "YouTube Uploads",
        "url": URL_YOUTUBE,
    },
    {
        "name": "TikTok",
        "header": "TIKTOK",
        "url_label": "TikTok Studio",
        "url": URL_TIKTOK,
    },
]
...
def build_caption(song_title: str) -> str:
...
def build_post_schedule_text(song_title: str, campaign_items: list[dict], hashtags: str) -> str:
    caption = build_caption(song_title)
    ...
    lines = [
        ...
        "- This file is grouped by platform.",
        "- Finish all Meta tasks first, then YouTube, then TikTok.",
        ...
        "- Use the filename, date, time, caption, and hashtags exactly as shown.",
        "",
        "URLs:",
        f"DistroKid: {URL_DISTROKID}",
        f"Meta (IG/FB): {URL_FACEBOOK}",
    ...
    return [
        ...
        },
        {
            ...
            "description": (
                ...
                f"This campaign contains 20 content moments and 60 scheduling tasks.\n"
                f"The schedule file is grouped by platform: Meta, YouTube, TikTok.\n"
...
def generate():
    ...
    schedule_txt_path.write_text(build_post_schedule_text(song_title, campaign_items, hashtags), encoding="utf-8")
    ...
    lines.extend([
        ...
        "20 content moments",
        "60 scheduling tasks",
        "Grouped by platform: Meta, YouTube, TikTok",
        "",
        "Post schedule:",
        "",
    ])
...
ttk.Label(main, text="Hashtags").grid(row=2, column=0, sticky="w")
hashtags_box = tk.Text(main, width=60, height=5, wrap="word")
hashtags_box.grid(row=3, column=0, columnspan=3, sticky="w", pady=(5, 15))
hashtags_box.insert("1.0", DEFAULT_HASHTAGS)

ttk.Label(main, text="Creative reel design").grid(row=4, column=0, columnspan=3, sticky="w", pady=(0, 5))
